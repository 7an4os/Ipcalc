...
#input=input()
input="10.191.170.29/255.255.250.0"
...
print ("Mask:      "+str(mask_dec_res[0])+"."+str(mask_dec_res[1])+"."+str(mask_dec_res[2])+"."+str(mask_dec_res[3]))
print ("Wildcard:  "+ str(wild_dec_res[0])+"."+ str(wild_dec_res[1])+"."+ str(wild_dec_res[2])+"."+ str(wild_dec_res[3]))
print ("Network:   "+ str(net_dec_res[0])+"."+ str(net_dec_res[1])+"."+ str(net_dec_res[2])+"."+ str(net_dec_res[3]))
print ("Broadcast: "+str(broad_dec_res[0])+"."+str(broad_dec_res[1])+"."+str(broad_dec_res[2])+"."+str(broad_dec_res[3]))
print ("hostMin:   "+str(net_dec_res[0])+"."+ str(net_dec_res[1])+"."+ str(net_dec_res[2])+"."+str(net_dec_res[3]+1))
print ("hostMax:   "+str(broad_dec_res[0])+"."+str(broad_dec_res[1])+"."+str(broad_dec_res[2])+"."+str(broad_dec_res[3]-1))
print ("Hosts/Net: "+str(hosts))
print ("Prefered gateway "+str(net_dec_res[0])+"."+ str(net_dec_res[1])+"."+ str(net_dec_res[2])+"."+str(net_dec_res[3]+1))
